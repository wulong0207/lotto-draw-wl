...
@Controller
@RequestMapping("/pc/zc6")
public class DrawSportZc6PcController extends BasePcController {

	private static final Logger logger = LoggerFactory.getLogger(DrawSportZc6PcController.class);
	...
	public ModelAndView detail(@PathVariable String issueCode) {
		...
		Integer lotteryCode = LotteryEnum.Lottery.ZC6.getName();
		// 开奖详情
