...
@Controller
@RequestMapping("/pc/jq4")
public class DrawSportJq4PcController extends BasePcController {
	...
	public ModelAndView detail(@PathVariable String issueCode) {
		...
		Integer lotteryCode = LotteryEnum.Lottery.JQ4.getName();
		// 开奖详情
