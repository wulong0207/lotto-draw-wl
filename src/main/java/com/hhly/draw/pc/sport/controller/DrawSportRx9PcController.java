...
@Controller
@RequestMapping("/pc/rx9")
public class DrawSportRx9PcController extends BasePcController {
	...
	public ModelAndView detail(@PathVariable String issueCode) {
		Integer lotteryCode = LotteryEnum.Lottery.ZC_NINE.getName();
		ModelAndView mav = new ModelAndView();
		// 开奖详情
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("lotteryCode", lotteryCode);
		params.put("issueCode", issueCode);
		String url = drawCoreUrl + "draw/rx9/detail";
		...
		if (result == null || result.isError() || result.getData() == null) {
			logger.error("查询任选9场开奖详情{}失败: {}", issueCode, result.getMessage());
